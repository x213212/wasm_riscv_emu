...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    loadPackage({"files": [{"filename": "/addi.bin", "start": 0, "end": 164}], "remote_package_size": 164});
...
var ASM_CONSTS = {
  21616: () => { FS.syncfs(false, function(err){}); },  
 21651: () => { FS.mkdir('/data'); FS.mount(IDBFS, {}, '/data'); FS.syncfs( true, function(err) { if (typeof Module.OnDataMounted !== 'undefined') { Module.OnDataMounted(); } }); }
};
