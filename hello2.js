...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'hello2.data';
      var REMOTE_PACKAGE_BASE = 'hello2.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_hello2.data');

      };
      Module['addRunDependency']('datafile_hello2.data');
    ...
    loadPackage({"files": [{"filename": "/addi.bin", "start": 0, "end": 4168}], "remote_package_size": 4168});
...
var ASM_CONSTS = {
  21280: () => { FS.syncfs(false, function (err) {} ); },  
 21318: () => { FS.mkdir('/data'); FS.mount(IDBFS, {}, '/data'); FS.syncfs(true, function (err) { if (typeof Module.OnDataMounted !== 'undefined') { Module.OnDataMounted(); } } ); }
};
...
/** @type {function(...*):?} */
var _sum2 = Module["_sum2"] = createExportWrapper("sum2");

/** @type {function(...*):?} */
var _LoadData = Module["_LoadData"] = createExportWrapper("LoadData");

/** @type {function(...*):?} */
var ___errno_location = Module["___errno_location"] = createExportWrapper("__errno_location");

/** @type {function(...*):?} */
var _SaveData = Module["_SaveData"] = createExportWrapper("SaveData");

/** @type {function(...*):?} */
var _queryString = Module["_queryString"] = createExportWrapper("queryString");

/** @type {function(...*):?} */
var _sum_up = Module["_sum_up"] = createExportWrapper("sum_up");
